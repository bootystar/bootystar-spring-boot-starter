package io.github.bootystar.autoconfigure.spring.aspect;

import io.github.bootystar.autoconfigure.exception.MethodLimitException;
import io.github.bootystar.autoconfigure.spring.annotation.MethodLimit;
import io.github.bootystar.autoconfigure.spring.handler.MethodLimitHandler;
import io.github.bootystar.autoconfigure.spring.handler.MethodSignatureHandler;
import io.github.bootystar.autoconfigure.spring.handler.impl.SpelMethodSignatureHandler;
...
public class MethodLimitAspect {
    ...
    @Pointcut("@annotation(io.github.bootystar.autoconfigure.spring.annotation.MethodLimit)")
